...
{
    [Serializable]
    [BaseName("Utility - Send Magic Message")]
    [BaseDescription("Sends a magic message to the motion controller. Typically to control a motion.")]
    public class Utility_SendMagicMessage : SpellAction
    {
        /// <summary>
